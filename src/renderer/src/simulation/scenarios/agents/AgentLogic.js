export class AgentLogic {
    ...
    static random(prng, generation = 0) {
    ...
    maybeLearnSkill(task, prng) {
        ...
        if (prng.next() > this.entity.genome.skillCreationThreshold) {
            ...
            if (this.entity.skills.some(s => s.targetTypes.includes(target)))
                return;
            // Create new skill
            const newSkill = {
